...
import pro4 from '../assets/img/pro_4.png';
import pro5 from '../assets/img/pro_5.png';
            ...
            <div className="card h-36 shadow-lg "> 
              ...
              <div className="card-body py-2"> 
                ...
                <BsCalendar2CheckFill size={25} color="#182C61" style={{ marginBottom:'17px', marginRight:'10px'}}/>
                  ...
                  <div className="d-flex align-items-center">
                  <IoIosApps size={35} color="#182C61" style={{ marginBottom:'77px', marginRight:'0px'}}/>
            ...
            <div className="card h-36 shadow-lg "> 
              ...
              <div className="card-body py-2"> 
                ...
                <BsCalendar2CheckFill size={25} color="#182C61" style={{ marginBottom:'17px', marginRight:'10px'}}/>
                  ...
                  <div className="d-flex align-items-center">
                  <IoIosApps size={35} color="#182C61" style={{ marginBottom:'97px', marginRight:'0px'}}/>
            ...
            <div className="card h-36 shadow-lg "> 
              ...
              <div className="card-body py-2"> 
                ...
                <BsCalendar2CheckFill size={25} color="#182C61" style={{ marginBottom:'17px', marginRight:'10px'}}/>
                    ...
                    <p style={{letterSpacing:'1px'}}>Jun 2023</p>
                  </div>
                  <div className="d-flex align-items-center">
                  <PiLightningFill size={25} color="#182C61" style={{ marginBottom:'17px', marginRight:'10px'}}/>
                 ...
                 <IoIosApps size={35} color="#182C61" style={{ marginBottom:'77px', marginRight:'0px'}}/>
                    ...
                    <br/>
                    <br/>
                    <span style={{ border:'1px solid gray',padding:'4px 6px', borderRadius:'20px', marginRight:'3px',marginLeft:'5px', color:'#182C61', fontWeight:'500',letterSpacing:'1px'}}>JQuery</span>
                    <span style={{ border:'1px solid gray',padding:'4px 6px', borderRadius:'20px', marginRight:'3px',marginLeft:'5px', color:'#182C61', fontWeight:'500',letterSpacing:'1px'}}>Web Speech API</span>
                    <br/>
                    <br/>
                     </p>
            ...
            <div className="card h-48 shadow-lg "> 
              ...
              <div className="card-body py-2"> 
                ...
                <BsCalendar2CheckFill size={25} color="#182C61" style={{ marginBottom:'17px', marginRight:'10px'}}/>
                  ...
                  <div className="d-flex align-items-center">
                  <IoIosApps size={35} color="#182C61" style={{ marginBottom:'20px', marginRight:'0px'}}/>
            ...
            <div className="card h-36 shadow-lg "> 
              ...
              <div className="card-body py-2"> 
                ...
                <BsCalendar2CheckFill size={25} color="#182C61" style={{ marginBottom:'17px', marginRight:'10px'}}/>
                    ...
                    <p style={{letterSpacing:'1px'}}>Mar 2023 - May 2023</p>
                  </div>
                  <div className="d-flex align-items-center">
                  <PiLightningFill size={25} color="#182C61" style={{ marginBottom:'17px', marginRight:'10px'}}/>
                  ...
                  <div className="d-flex align-items-center">
                  <IoIosApps size={35} color="#182C61" style={{ marginBottom:'17px', marginRight:'0px'}}/>

                  <p> <span style={{ border:'1px solid gray',padding:'4px 6px', borderRadius:'20px', marginRight:'3px',marginLeft:'5px', color:'#182C61', fontWeight:'500',letterSpacing:'1px'}}>Core Java</span> 
                    <span style={{ border:'1px solid gray',padding:'4px 6px', borderRadius:'20px', marginRight:'3px',marginLeft:'5px', color:'#182C61', fontWeight:'500',letterSpacing:'1px'}}>XML</span>
                    <span style={{ border:'1px solid gray',padding:'4px 6px', borderRadius:'20px', marginRight:'3px',marginLeft:'5px', color:'#182C61', fontWeight:'500',letterSpacing:'1px'}}>Android</span>
                    <span style={{ border:'1px solid gray',padding:'4px 6px', borderRadius:'20px', marginRight:'3px',marginLeft:'5px', color:'#182C61', fontWeight:'500',letterSpacing:'1px'}}>JSON</span>
                     </p>
